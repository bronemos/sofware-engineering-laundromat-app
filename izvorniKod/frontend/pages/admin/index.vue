      ...
      <form>
        <div class="row">
          <div class="col-md-6">
            <div class="profile-head">
              ...
              <ul class="nav nav-tabs" id="myTab">
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'hours' ? 'active' : ''" id="details" @click.prevent="
                      tabSelected = 'hours';
                      editHours = false;
                      addingWorker = false;
                    ">
                ...
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'employees' ? 'active' : ''" id="employees" @click.prevent="
                ...
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'reviews' ? 'active' : ''" id="reviews" @click.prevent="
                      tabSelected = 'reviews';
                      editHours = false;
                      addingWorker = false;
                    ">
          ...
          <div class="col-md-2" v-if="tabSelected === 'hours'">
            <input type="button" class="profile-edit-btn" name="btnAddMore" :value="this.editHours ? $t('save') : $t('edit')" @click.prevent="updateHours" />
          </div>
          <div class="col-md-2" v-if="tabSelected === 'employees'">
            <input type="button" class="profile-worker-btn" name="btnAddMore" v-bind:value="$t('addWorker')" @click.prevent="addWorker" />
          </div>
        </div>
          ...
          <table>
            ...
            <tbody>
              <tr v-for="user in listUsers" :key="user.id" class="show_bt'">
                ...
                <td>
                  <button type="button" id="myBtn-user" class="myBtn" @click="deleteUser(user.id)">{{ $t("block") }}</button>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <div class="tab-pane fade show active" id="details-tab-edit">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="error" v-if="!verifyPw(workerPassword) && workerPassword.length !== 0">{{ $t("passwordInvalid") }}
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="error" v-if="!(workerPassword === workerRepeatedPassword) && workerPassword.length !== 0 && workerRepeatedPassword.length !== 0">
                      {{ $t("passwordNotSame") }}
                    </div>
                  </div>
                </div>
