          ...
          <div class="col-md-6">
            <div class="profile-head">
              ...
              <ul class="nav nav-tabs" id="myTab">
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'details' ? 'active' : ''" id="details" @click.prevent="tabSelected='details'; editProfile=false">{{ $t("details") }}
                  </button>
                </li>
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'payment' ? 'active' : ''" id="payment" @click.prevent="tabSelected='payment'; editProfile=false">{{ $t("paymentData") }}
                  </button>
                </li>
                <li class="nav-item">
                  <button class="nav-link" v-bind:class="tabSelected === 'reservations' ? 'active' : ''" id="reservations" @click.prevent="tabSelected='reservations'; editProfile=false">{{ $t("reservationList") }}
                  </button>
                </li>
              </ul>
            </div>
              ...
              <div class="tab-pane fade show active" id="details-tab-edit" v-if="tabSelected === 'details'">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="error" v-if="!(password === repeatedPassword) && password.length !== 0 && repeatedPassword.length !== 0">
                      {{ $t("passwordNotSame") }}
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <form class="form-card" action="#">
                <label class="label-card" for="number">{{ $t("cardNumber") }}
                  <input class="input-card" type="text" id="number" :value="'•••• •••• •••• ' + user.card.cc_number.slice(-4)" disabled />
                </label>
                <label class="label-name label-card" for="name">{{ $t("nameAndSurname") }}
                  <input class="input-card" type="text" id="name" :placeholder="user.first_name + ' ' + user.last_name" disabled />
                </label>
                <label class="label-date label-card" for="date">{{ $t("validBy") }}
                  <input class="input-card" type="text" id="date" :value="user.card.cc_expiry.split('-')[1] + '/' + user.card.cc_expiry.split('-')[0].slice(-2)" disabled />
                </label>
        ...
        <div class="row" v-if="tabSelected === 'payment' && (editProfile || user.card === null)">
          <div id="page-edit" class="page">
            <div class="card">
              ...
              <form class="form-card" action="#">
                <label class="label-card" for="number">{{ $t("cardNumber") }}
                  <input class="input-card" type="text" id="number-edit" placeholder="0000 0000 0000 0000" v-model="cardNumber" v-on:keypress="addCardNumberSpace" maxlength="19" />
                </label>
                <label class="label-name label-card" for="name">{{ $t("nameAndSurname") }}
                  <input class="input-card" type="text" id="name-edit" :value="user.first_name + ' ' + user.last_name" disabled />
                </label>
                <label class="label-date label-card" for="date">{{ $t("validBy") }}
                  <input v-on:keypress="addExpirySlash" maxlength="5" class="input-card" type="text" id="date-edit" placeholder="MM/YY" v-model="expiryDate" ref="expDate" />
                </label>
                <label class="label-cvc label-card" for="cvc">CVV
