...
\begin{packed_enum}
	...
	\item Korisnici praonice rublja				
	\item Zaposlenici praonice rublja
...
\begin{packed_enum}
	...
	\begin{packed_enum}
		...
		\item vidjeti oglase za posao (osobe koje ne žive u domu i nisu studenti, odnosno nemaju pravo koristiti praonicu, mogu se zaposliti u praonici, prijave za oglas ne idu putem aplikacije, već se molba i životopis šalju na adresu e-pošte navedenu u oglasu)
	...
	\begin{packed_enum}
		...
		\item rezervirati termin za pranje i sušenje rublja
	...
	\begin{packed_enum}
		...
		\item prijaviti se u sustav
		\item pregledati vlastiti profil i uređivati podatke
		\item pristupiti zidu s obavijestima o izgubljenim stvarima
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Sustav korisnika vraća na početnu stranicu i dojavljuje da prijava nije uspjela
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[2.a] Korisnik nema sredstava na računu
		\item[] \begin{packed_enum}
			
			\item Korisniku se ispisuje upozorenje da nema sredstava na računu
...
\noindent \underbar{\textbf{UC5 - Pristup kalendaru s terminima}}
\begin{packed_item}
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Administrator popunjava tekst i podatke oglasa
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Odabire opciju za uređivanje oglasa nakon objave
			\item Administrator ispravlja pogrešku
			\item Odabire opciju za spremanje promjena
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Prikaže se prozor za odabir novog radnog vremena
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Prikaže se prozor za unos nove cijene sušenja
...
\begin{packed_item}
	...
	\item \textbf{Glavni sudionik: } Administrator
	\item  \textbf{Cilj:} Zabraniti pristup korisniku uslugama praonice 
	\item  \textbf{Sudionici:} Baza podataka
	\item  \textbf{Preduvjet:} Korisnik je registriran i dodijeljena su mu prava administratora
	\item  \textbf{Opis osnovnog tijeka:}
	...
	\item[] \begin{packed_item}
		...
		\item[2.a] Ne postoje registrirani korisnici
		\item[] \begin{packed_enum}
			
			\item Prikaže se odgovarajuća poruka
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[2.a] Nema objavljenih oglasa
		\item[] \begin{packed_enum}
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Sustav obavještava zaposlenika da to vrijeme pauze nije dozvoljeno i nudi mu opciju mijenjanja termina pauze
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[1.a] Korisnik ima nevažeću potvrdu o stanovanju u studentskom   domu 
		\item[] \begin{packed_enum}
...
\textbf{Obrazac uporabe UC4 - Rezervacija termina za pranje rublja}\\
...
\begin{packed_item}
	...
	\item Morat će postojati ograničenje rezervacije dva termina dnevno za svakog registriranog korisnika
	...
	\item Za sve novčane transakcije koristi HRK kao valutu
